...
componentDidMount() {
  setTimeout(() => {
    console.log('Add selectedMonth ::'+this.props.selectedMonth+' selectedYear ::'+this.props.selectedYear);
...
render() {
   if(this.state.messageFromServer == ''){
      return (
        <div>
      <Button bsStyle="success" bsSize="small" onClick={this.openModal}><span className="fas fa-plus"></span></Button>
          <Modal
...
<Link to={{pathname: '/', search: '?month=All&year='+this.state.year }} style={{ textDecoration: 'none' }}>
       <Button bsStyle="danger" bsSize="mini" onClick={this.closeModal} className="closebtn"><span className="fas fa-window-close"></span></Button>
      </Link><br/>
<fieldset>
